          ...
          <div className="w-[70%] border border-gray-500 border-collapse">
            ...
            <div className="flex border-b border-gray-500 border-collapse">
              ...
              <div className="py-2 px-3 text-left">
                <h3>제 1 조 (목 적)</h3>
                <p className="mt-3">
                  이 약관은 SK커뮤니케이션즈 주식회사(이하 "회사"라 합니다)가
                  제공하는 위치기반서비스(이하 "서비스"라 합니다)와 관련하여, 회
                  사와 이용고객(또는 회원)간에 서비스의 이용조건 및 절차, 회사와
                  회원간의 권리·의무 및 기타 필요한 사항을 규정함을 목적으로
                  합니다.
                </p>
                <p className="mt-2">제 2 조 (용어의 정의)</p>
                <p className="mt-2">
                  이 약관에서 사용하는 용어의 정의는 다음 각호와 같으며,
                  정의되지 않은 용어에 대한 해석은 관계법령 및 서비스 안내에서
                  정하는 바에 따릅니다.
                </p>
                <p>
                  1&#41; "회원"이라 함은 이 약관에 동의하여 서비스를 이용하는
                  자를 말합니다.
                </p>
                <p>
                  2&#41; "위치정보"라 함은 이동성이 있는 물건 또는 개인이 특정한
                  시간에 존재하거나 존재하였던 장소에 관한 정보로서
                  전기통신기본법 제2조 제2호 및 제3호의 규정에 따른 전기통신설비
                  및 전기통신회선설비를 이용하여 수집된 것을 말합니다.
                </p>
                <p>
                  3&#41; "개인위치정보"라 함은 특정 개인의
                  위치정보(위치정보만으로는 특정 개인의 위치를 알 수 없는
                  경우에도 다른 정보와 용이하게 결합하여 특정 개인의 위치를 알
                ...
                <p>
                  ...
                  제공받는 자, 취득경로, 이용·제공일시 및 이용·제공방법에 관한
                  자료(위치 정보를 제외합니다)를 말합니다.
                </p>
                <p>
                  7&#41; "위치정보시스템"이라 함은 위치정보사업 및
                  위치기반서비스 사업을 위하여 정보통신망 이용촉진 및 정보보호
                  등에 관한 법률 제 2조 제1항 제1호의 규정에 의한 정보통신망을
                  통하여 위치정보를 수집·저장·분석·이용 및 제공할 수 있도록 서로
                  유기적으로 연계된 컴퓨터의 하드웨어, 소프트웨어, 데이터베이스
                  및 인적자원의 결합체를 말합니다.
                </p>
                <p>
                  8&#41; "게시물"이라 함은 회원이 작성한 텍스트나 촬영한 이미지,
                  동영상 등 정보 일체를 말합니다.
                </p>
              </div>
            </div>
