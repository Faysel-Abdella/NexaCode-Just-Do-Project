        ...
        <section className="w-[650px] py-5 px-5 border-2 border-gray-600 shadow-lg shadow-gray-700 ">
          <div className=" border-b-2 border-gray-400 ">
            <div className="flex justify-between items-center px-2">
              <h3 className="font-semibold">그룹 설정</h3>
              <button
      ...
      >
        <section className="w-[400px] py-5 px-5 border-2 border-gray-600 shadow-lg shadow-gray-700 text-black">
          <div className=" border-b-2 border-gray-400 ">
            <div className="flex justify-between items-center px-2">
              <h3>
                {selectedIdType === "normal" && "그룹 정상"}
                {selectedIdType === "stop" && "그룹 정지"}
                {selectedIdType === "delete" && "그룹 삭제"}
              </h3>
              <button
                className="font-semibold text-[16px]"
